...
var S = ["src", "title"], C = /* @__PURE__ */ i({
	...
	setup(t) {
		...
		return s(async () => {
			N.value = u.basePath ? u.src + (M.value || "") : u.src;
			let t = x.value;
			if (!t) return;
			u.fullHeight && t.parentElement && (E = t.parentElement.clientHeight);
			function n() {
				return C && C.destroy(), C = e({
					iframe: t,
					...
					methods: {
						...
						onRemoteRouteChange(e) {
							if (u.basePath) {
								let t = u.basePath + e;
								y.fullPath !== t && (O = !0, k || A ? (k = !1, A = !1, b.replace(t)) : b.push(t));
							}
							_ && _.handleRouteChange(e), u.fullHeight && F();
						},
						onRemoteHeight(e) {
