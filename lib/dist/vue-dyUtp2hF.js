import { t as e } from "./messenger-C-bB4YoP.js";
import { t } from "./connection-BXAf713t.js";
import "./sprRemoteLegacy-CbRXq27s.js";
...
function b() {
	let t = e(), n = d(y(t.status)), r = d(t.iframeLoaded);
	return {
		status: n,
		iframeLoaded: r,
		setIframeLoaded() {
			t.setIframeLoaded(), r.value = !0;
		},
		setConnection(e) {
			t.setConnection(e), e.then(() => {
				n.value = y(t.status);
			}).catch(() => {
				n.value = y(t.status);
			});
		...
		handleRemoteMessage(e) {
			t.handleRemoteMessage(e);
		},
		handleRouteChange(e) {
			t.handleRouteChange(e);
		},
		onMessage(e) {
			t.onMessage(e);
		},
...
var S = ["src", "title"], C = /* @__PURE__ */ i({
	...
	setup(e) {
		let i = Symbol.for("remote-messenger"), u = e, _ = a(i, null), y = h(), b = g(), x = d(null), C = null, w = null, T = d(0), E = 0, D = n(() => {
			let e = {
				width: "100%",
				border: "none"
			};
		...
		return s(async () => {
			...
			let e = x.value;
			if (!e) return;
			u.fullHeight && e.parentElement && (E = e.parentElement.clientHeight);
			function n() {
				return C && C.destroy(), j = Date.now(), k = !0, C = t({
					iframe: e,
